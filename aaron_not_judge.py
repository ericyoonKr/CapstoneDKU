...
import sys
import os
# import json # Not needed as metadata saving is disabled
from picamera2 import Picamera2
# from yolov5 import YOLOv5 # Not needed as YOLOv5 is disabled
...
output_filename_base = "nojudge" # CHANGED to nojudge
...
if not os.access('.', os.W_OK):
    ...
    if 'picam2' in locals() and hasattr(picam2, 'started') and picam2.started: picam2.stop() # hasattr check
    sys.exit(1)
...
# --- Setup for Saving Predicted Frames and Metadata --- (DISABLED)
...
frame_count = 0
processing_fps = 0
# prediction_interval = 3 # Not needed
# count = 0 # Not needed
# last_detections = [] # Not needed

# --- Drawing Settings --- (DISABLED as no detections are drawn)
# box_color = (0, 255, 0)
...
try:
    while True:
        ...
        try:
            ...
            # Apply color conversion as per previous requirement
        ...
        # current_frame_number = frame_count # Not strictly needed if not saving individual frames

        # --- YOLOv5 Detection and Drawing Logic --- (DISABLED)
        # image_path_for_current_detected_frame = None
        # image_filename_for_metadata = None

        # if count == 0:
        #     try:
        #         # ... (YOLO prediction logic commented out) ...
        #         # ... (Drawing boxes logic commented out) ...
        #         # ... (Metadata append logic commented out) ...
        #         pass # Placeholder if entire try-except is kept but content removed
        #     except Exception as e_extract:
        #          print(f"\nWarning: Error during disabled detection phase: {e_extract}") # Should not happen
        # else:
        #     # ... (Drawing last_detections logic commented out) ...
        #     pass

        # count += 1
        # if count >= prediction_interval: count = 0
        # --- END OF DISABLED DETECTION LOGIC ---
        ...
        # Use specific font settings for info_text, as global ones might be commented out
        ...
        # Prepare write_frame (this is what goes into the video)
        ...
        # --- Save individual predicted frame --- (DISABLED)
    ...
    print("\nReleasing resources...")
    if 'picam2' in locals() and hasattr(picam2, 'started') and picam2.started: # hasattr check
        picam2.stop()
    ...
    # --- Saving Prediction Metadata --- (DISABLED)
    ...
    # else:
    #     print("\nNo prediction metadata was recorded during the session.") # Changed this message slightly
